...
function sz_register_styles(){
	wp_enqueue_style('sz_css_normalize', get_template_directory_uri() . "/assets/css/normalize.css", array(), '1.0', 'all');
	wp_enqueue_style('sz_css_boilerplate', get_template_directory_uri() . "/assets/css/boilerplate.css", array(), '1.0', 'all');
	wp_enqueue_style('sz_css_style', get_template_directory_uri() . "/assets/css/style.css", array(), '1.0', 'all');
	wp_enqueue_style('sz_css_menu', get_template_directory_uri() . "/assets/css/menu.css", array(), '1.0', 'all');
}
